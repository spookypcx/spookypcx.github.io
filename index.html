...
<head>
    ...
    <title>Game Reverse Engineering - SpookyPCX</title>
...
<body>
    ...
    <div class="content">
        <h1>Welcome to SpookyPCX's Game Reverse Engineering Blog</h1>
        <p>Dive deep into the fascinating world of video game internals. Uncover secrets, analyze code, and master the art of game reverse engineering.</p>
        <p>From memory hacking to advanced disassembly, join us on a journey through the digital realms of your favorite games.</p>
        <a href="/blog" class="button">Start Hacking!</a>
    </div>

    <audio id="background-music" src="/audio/out-getting-ribs.mp3" autoplay loop></audio>
